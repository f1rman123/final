...
if(isset($_GET['buyProduk'])){
    $kurangStok = $conn->prepare("update produk set produk_stok = produk_stok - 1 where produk_id = ?");
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
              <a class="nav-link js-scroll-trigger text-white " href="index.php">Beranda <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
      ...
      <!-- Akhir Navbar -->
        ...
        <div class="container row" id="prodak" style="padding-top:100px;">
            <div class="row mt-2" >
                <div class="col-4"></div>
                <div class="col-6">
                    <img src="<?php echo $selectedBarang['produk_img'];?>" class="img-fluid" style="max-height:500px;">
                </div>
                <div class="col-2">
                    <table class="table table-borderless">
                        <tr>
                            <th>Nama Produk</th>
                            <td><?php echo $selectedBarang['produk_nama'];?></td>
                        </tr>
                        <tr>
                            <th>Ukuran</th>
                            <td> M </td>
                        ...
                        <tr>
                            <th>Stok Prodak</th>
                            <td> <?php echo $selectedBarang['produk_stok'];?> pcs</td>
                        </tr>
                        <tr>
                            <th>Harga</th>
                            <td>Rp. <?php echo number_format($selectedBarang['produk_harga']);?></td>
                        </tr>
                        <tr>
                            <th>
                            <a href="detail.php?changeModal=<?php echo $selectedBarang['produk_id'];?>&buyProduk=1" class="btn btn-danger" >Beli</a></th>
                            <td><button class="btn btn-primary" onclick="window.location.href='index.php'">Kembali</button>
                        </td>
                        </tr>
                    </table>
                </div>
